...
![Release date](https://img.shields.io/badge/Release%20date-Mar.%2013%2C%202020-brightgreen.svg)
...
Important features of the query sample, such as the meta-data of habitat, status, etc., can potentially be predicted based on the meta-data of its matches. From the search output generated by [MetaDB-search-\*](#search-the-mse-database), the meta-data of the query sample can be predicted by:
